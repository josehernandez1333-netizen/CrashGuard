#############################################################################
# Makefile for building: CrashGuard
# Generated by qmake (3.1) (Qt 5.15.8)
# Project:  CrashGuard.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile CrashGuard.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = CrashGuard1.0.0
DISTDIR = /home/pi/CrashGuard/.tmp/CrashGuard1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lcurl /usr/lib/arm-linux-gnueabihf/libQt5Gui.so /usr/lib/arm-linux-gnueabihf/libQt5Core.so -lGLESv2 -lpthread -latomic   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		...
		CrashGuard.pro imu/imu.h \
		modem/modem.h \
		cloud/cloud_client.h main.cpp \
		imu/imu.cpp \
		modem/modem.cpp \
		cloud/cloud_client.cpp
QMAKE_TARGET  = CrashGuard
DESTDIR       = 
TARGET        = CrashGuard
...
Makefile: CrashGuard.pro /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/unix.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/linux.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/lex.prf \
		CrashGuard.pro
	$(QMAKE) -o Makefile CrashGuard.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents imu/imu.h modem/modem.h cloud/cloud_client.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp imu/imu.cpp modem/modem.cpp cloud/cloud_client.cpp $(DISTDIR)/
...
main.o: main.cpp imu/imu.h \
		modem/modem.h \
		cloud/cloud_client.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

imu.o: imu/imu.cpp imu/imu.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o imu.o imu/imu.cpp

modem.o: modem/modem.cpp modem/modem.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o modem.o modem/modem.cpp

cloud_client.o: cloud/cloud_client.cpp cloud/cloud_client.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o cloud_client.o cloud/cloud_client.cpp
